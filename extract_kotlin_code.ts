...
const mainFolder = "/Users/agus/Documents/Entorno/FollowApps/Android/MyTasks/app/src/main/java/com/followapp/mytasks";
...
function splitIntoGroups(content: string[], maxGroupSize = 4000): string[] {
  const groups: string[] = [];
  let currentGroup = "";
  let groupNumber = 1;
